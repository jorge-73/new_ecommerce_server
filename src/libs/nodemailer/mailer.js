...
import { NODEMAILER_PASS, NODEMAILER_USER, PORT, CLIENT_URL } from "../../utils/variables.js";
...
export const sendAccountDeleteEmail = async (userEmail) => {
  let config = {
    service: "gmail",
    auth: {
      user: NODEMAILER_USER,
    ...
    body: {
      ...
      action: {
        ...
        button: {
          ...
          link: `${CLIENT_URL}/passwordChange/${tokenLink}`,
        },
      },
      outro:
